...
./helpers/_installIfExists.sh btop dust fd fzf lazygit ripgrep stow stress vim

echo "Installing fun packages..."
#./_installIfExists.sh sysstate tmuxinator powerline powertop
./helpers/_installIfExists.sh wget cmake fastfetch stow tmux zsh tree zip unzip entr
...
# Apple already uses zsh as the default shell.
